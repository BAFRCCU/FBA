...
namespace ViewerGroups
{
    public partial class ViewerGroups : Form
    {
            ...
            if (Directory.Exists(pathToSave + "\\GROUPS") && File.Exists(pathToSave + "\\TXT\\groups.txt"))
            {
                ...
                foreach (string li in File.ReadAllLines(pathToSave + "\\TXT\\groups.txt"))
                {
                    ...
                    try
                    {
                        ...
                        {
                            Image img = global::ViewerGroups.Properties.Resources.anonymous;
        ...
        //                else
        //                {
        //                    //Image img = ViewerGroups.Properties.Resources.Business_Shop_icon;
        //                    Button bouton = new Button();
        //                    //dataGridViewArticles.Rows.Add(bouton,img, champ[0], champ[1], champ[2]);
        ...
        private void dataGridViewArticles_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
