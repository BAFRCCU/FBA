...

{
    public partial class Viewer : Form
    {
        ...
        ThumbnailFlowLayoutPanel flowLayoutImagesInstagram = new ThumbnailFlowLayoutPanel();
        ...
        public Viewer(Initcontrol init)
        {
            Visible = false;
            InitializeComponent();
            ...
            flowLayoutImagesInstagram.Visible = true;
            flowLayoutImagesInstagram.Dock = System.Windows.Forms.DockStyle.Fill;
            flowLayoutImagesInstagram.FlowDirection = FlowDirection.LeftToRight;
            //flowLayoutImagesActives.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
            //| System.Windows.Forms.AnchorStyles.Left)));
            flowLayoutImagesInstagram.AutoScroll = true;
            flowLayoutImagesInstagram.BackColor = System.Drawing.Color.White;
            flowLayoutImagesInstagram.Location = new System.Drawing.Point(0, 0);
            flowLayoutImagesInstagram.Name = "flowLayoutImagesInstagram";
            flowLayoutImagesInstagram.Size = new System.Drawing.Size(1440, 800);



            panelSeparator.Controls.Add(flowLayoutImagesActives);
            toolTip1.SetToolTip(pictureBox11, "Cliquez pour le 'A propos'");
            ...
            oval.Location = new System.Drawing.Point(384, 44);
            ...
            oval.BringToFront();
            oval.Visible = true;
            oval.Click += new System.EventHandler(this.pictureBoxtango_Click);
            toolTip1.SetToolTip(oval, "Double clic pour voir la page 'About'");
            ...
            iconsList.Images.Add(global::Viewer.Properties.Resources.Messenger_icon);
            iconsList.Images.Add(global::Viewer.Resources.instagram_logos_png_images_free_download_2);

            tabControl1.ImageList = iconsList;
            MESSENGER.ImageIndex = 0;
            INSTAGRAM.ImageIndex = 1;
            ...
            if (dataGridView2.Rows.Count > 0)
            {
                ...
                label42.Text += " : " + dataGridView2.Rows.Count;
            }
            else
            {
            ...
            {
                Image img = global::Viewer.Properties.Resources.friends;
                dataGridViewResume.Rows.Add(img,dataGridView1.Rows.Count, "ABONNES");
                label43.Text += " : " + dataGridView2.Rows.Count;
            ...
            {
                Image img = global::Viewer.Properties.Resources.friends;
                dataGridViewResume.Rows.Add(img, dataGridViewGroups.Rows.Count, "GROUPES");
                label49.Text += " : " + dataGridViewGroups.Rows.Count;
                //labelFriends.Text = "AMIS : " + dataGridView2.Rows.Count;
            }
            else
            {
            ...
            if (dataGridView1.Rows.Count == 0 && dataGridView2.Rows.Count ==0 && dataGridViewMap.Rows.Count == 0)
            ...
            string pictures = GetNumberPictures();
            if (pictures != "0")
            {
                Image img = global::Viewer.Properties.Resources.pictures_1320567790130713653_64;
                
                dataGridViewResume.Rows.Add(img,pictures, "IMAGES");
            ...
            {
                Image img = global::Viewer.Properties.Resources.like_icon;
                dataGridViewResume.Rows.Add(img, dataGridViewLikes.Rows.Count, "LIKES");
                //labelMessenger.Text = "MESSENGER : " + dataGridViewMessenger.Rows.Count;
            }
            else
            {
                tabControl1.Controls.Remove(tabControl1.Controls["tabPageLikes"]);
                //tabToBeRemoved.Add(3);
                //labelMessenger.Text = "MESSENGER : " + dataGridViewMessenger.Rows.Count;
            ...
            {
                tabControl1.Controls.Remove(tabControl1.Controls["MUR"]);
                //tabToBeRemoved.Add(2);
                //labelJournal.Text = "JOURNAL : " + GetNumberHomePage();

            }

            string tags = GetNumberTags();
            if (tags != "0")
            {
                Image img = global::Viewer.Properties.Resources.tags;
                dataGridViewResume.Rows.Add(img, tags, "TAGS");
                FillTags();
                //labelJournal.Text = "JOURNAL : " + GetNumberHomePage();
            ...
            {
                tabControl1.Controls.Remove(tabControl1.Controls["TAGS"]);
                //tabToBeRemoved.Add(2);
                //labelJournal.Text = "JOURNAL : " + GetNumberHomePage();

            }

            string comments = GetNumberComments();
            if (comments != "0")
            {
                Image img = global::Viewer.Properties.Resources.comments;
                dataGridViewResume.Rows.Add(img, comments, "COMMENTS");
                FillComments();
                //labelJournal.Text = "JOURNAL : " + GetNumberHomePage();
            ...
            {
                tabControl1.Controls.Remove(tabControl1.Controls["COMMENT"]);
                //tabToBeRemoved.Add(2);
                //labelJournal.Text = "JOURNAL : " + GetNumberHomePage();

            }

            if (GetNumberInstagram() != "0")
            {
                Image img = global::Viewer.Resources.instagram_logos_png_images_free_download_2;
                dataGridViewResume.Rows.Add(img, GetNumberInstagram(), "INSTAGRAM");
                FillInstagram();
                //labelJournal.Text = "JOURNAL : " + GetNumberHomePage();
            ...
            {
                tabControl1.Controls.Remove(tabControl1.Controls["INSTAGRAM"]);
                //tabToBeRemoved.Add(2);
                //labelJournal.Text = "JOURNAL : " + GetNumberHomePage();
            ...
            {
                Image img = global::Viewer.Properties.Resources.map;
                dataGridViewResume.Rows.Add(img, dataGridViewMap.Rows.Count, "LIEUX");
                label44.Text += " : " + dataGridViewMap.Rows.Count;
                //labelFriends.Text = "AMIS : " + dataGridView2.Rows.Count;
            }
            else
            {
                label44.Visible = false;
                dataGridViewMap.Visible = false;
            }


            if (File.Exists(pathConfig + "\\TXT\\Allidentifiants.txt"))              
            {
                string fi = File.ReadAllText(pathConfig + "\\TXT\\Allidentifiants.txt");
                if (fi == "")
                {
                    tabControl1.Controls.Remove(tabControl1.Controls["tabPage3"]);
                    return;
                }
                    

                Image img = global::Viewer.Properties.Resources._141ab281;
                dataGridViewResume.Rows.Add(img,File.ReadAllLines(pathConfig + "\\TXT\\Allidentifiants.txt").Length, "IDENTIFIANTS");
                //labelIdentifiants.Text = "IDENTIFIANTS : " + File.ReadAllLines(pathConfig + "\\AllIdentifiants.txt").Length;

            }
            else
            {
                tabControl1.Controls.Remove(tabControl1.Controls["IDENTIFIANTS"]);
            }
        ...
        private string GetNumberComments()
        {
            int nbre = 0;

            if (File.Exists(pathConfig + @"\TXT\comments.txt"))
                nbre = File.ReadAllLines(pathConfig + @"\TXT\comments.txt").Count();

            if (File.Exists(pathConfig + @"\TXT\pagesLiked.txt"))
                nbre += File.ReadAllLines(pathConfig + @"\TXT\pagesLiked.txt").Count();


            return nbre.ToString();
        }

        private void FillInstagram()
        {
            //if (Directory.Exists(pathToSave + "\\INSTAGRAM"))
            //{
            dataGridViewInstagram.Rows.Clear();
            string[] files = Directory.GetFiles(pathConfig + "\\TXT", "instagram*");
            ...
            foreach (string fichier in files)
            {
                foreach (string li in File.ReadAllLines(fichier))
                {
                    ...
                    try
                    {
                        if (File.Exists(pathConfig + "\\INSTAGRAM\\Profile\\" + photoProfil))
                        {
                            FileInfo fichierr = new FileInfo(pathConfig + "\\INSTAGRAM\\Profile\\" + photoProfil.Replace(".//", ""));
                        ...
                        {
                            imgProfil = global::Viewer.Properties.Resources.anonymous;
                            //dataGridViewTags.Rows.Add(img, champ[0], champ[1], champ[2]);
                            //continue;
                        }

                        if (File.Exists(pathConfig + "\\INSTAGRAM\\" + screenshot))
                        {
                            FileInfo fichierr = new FileInfo(pathConfig + "\\INSTAGRAM\\" + screenshot);
                        ...
                        {
                            Screenshot = global::Viewer.Properties.Resources.anonymous;
                            //dataGridViewTags.Rows.Add(img, champ[0], champ[1], champ[2]);
                            //continue;
                        }
                        ...
                        if (!Directory.Exists(pathConfig + "\\INSTAGRAM\\ALBUM\\" + screenshot.Substring(0, screenshot.IndexOf("\\"))))
                        {
            ...
            files = Directory.GetFiles(pathConfig + "\\TXT", "identity_instagram*");
            ...
            files = Directory.GetFiles(pathConfig + "\\TXT", "FollowersInstagram.txt");
            ...
            foreach (string fichier in files)
            {
                foreach (string li in File.ReadAllLines(fichier))
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            if (File.Exists(pathConfig + "\\INSTAGRAM\\FollowersProfiles\\" + photoProfil))
                            {
                                FileInfo fichierr = new FileInfo(pathConfig + "\\INSTAGRAM\\FollowersProfiles\\" + photoProfil);
                                imgProfil = ResizeImage(fichierr.FullName, 150, 150, false);
            ...
            files = Directory.GetFiles(pathConfig + "\\TXT", "FollowingsInstagram.txt");
            ...
            foreach (string fichier in files)
            {
                ...
                foreach (string li in File.ReadAllLines(fichier))
                {
                    try
                    {
                        ...
                        try
                        {
                            if (File.Exists(pathConfig + "\\INSTAGRAM\\FollowingProfiles\\" + photoProfil))
                            {
                                FileInfo fichierr = new FileInfo(pathConfig + "\\INSTAGRAM\\FollowingProfiles\\" + photoProfil);
                                imgProfil = ResizeImage(fichierr.FullName, 150, 150, false);
            ...
            ////TOUTES
            FillPicturesWithThumbnaiINSTAGRAMl();

            //dataGridViewAllPublicatons.Rows.Clear();
            //string[] dirs = Directory.GetDirectories(pathConfig + "\\INSTAGRAM");
        ...
        private string GetNumberInstagram()
        {
            ...
            if (Directory.Exists(pathConfig + "INSTAGRAM"))
            {
                int i = 0;
                foreach(string dirr in Directory.GetDirectories(pathConfig + "INSTAGRAM"))
                {
                    if (dirr.ToLower().Contains("profil") || dirr.ToLower().Contains("album"))
                        continue;
                    i++;
                }
                ...
                if(nbreDir == 0)
                {
                    tabControl3.Controls.Remove(tabControl3.Controls["tabPage6"]);
                    tabControl3.Controls.Remove(tabControl3.Controls["tabPage7"]);
                }
            ...
            //    nbreDir = Directory.GetDirectories(pathConfig + "INSTAGRAM\\ALBUM\\").Count();
            ...
            //if (Directory.Exists(pathConfig + "INSTAGRAM\\FollowersProfiles"))
            //{

            //    nbreDir = 1;
            //}

            //if (Directory.Exists(pathConfig + "INSTAGRAM\\FollowingProfiles"))
            //{
        ...
        {
            if (Directory.Exists(pathConfig + "\\PICTURES_TAGGED") && File.Exists(pathConfig + "\\TXT\\tags.txt"))
            {
                dataGridViewTags.Rows.Clear();
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\tags.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    try
                    {
                        if (File.Exists(Directory.GetFiles(pathConfig + "\\PICTURES_TAGGED\\", champ[2])[0]))
                        {
                            FileInfo fichierr = new FileInfo(Directory.GetFiles(pathConfig + "\\PICTURES_TAGGED\\", champ[2])[0]);
        ...
        private string GetNumberTags()
        {
            if (Directory.Exists(pathConfig + "\\PICTURES_TAGGED"))
            {
                return Directory.GetFiles(pathConfig + "\\PICTURES_TAGGED", "*.png").Count().ToString();
            }

            return "0";
        }

        private string GetNumberInstagram(string u)
        {
            if (Directory.Exists(pathConfig + "\\INSTRAGRAM"))
            {
                return Directory.GetFiles(pathConfig + "\\PICTURES_TAGGED", "*.png").Count().ToString();
            }
        ...
        private string GetNumberMap()
        {
            if (Directory.Exists(pathConfig + "\\MAP"))
            {
                return Directory.GetFiles(pathConfig + "\\MAP", "*.png").Count().ToString();
            }

            return "0";
        }

        private void RestoreFromFolders()
        {
            if(Directory.Exists(pathConfig + "\\Messenger") && (Directory.Exists(pathConfig + "\\Messenger\\PicturesProfiles")))
            {
                dataGridViewMessenger.Rows.Clear();
                foreach (string dir in Directory.GetDirectories(pathConfig + "\\Messenger"))
                {
                    DirectoryInfo dirr = new DirectoryInfo(dir);

                    if(dirr.Name == "PicturesProfiles")
                            continue;
                    
                    if(File.Exists(pathConfig + "\\Messenger\\PicturesProfiles\\" + dirr.Name + ".jpg"))
                    {
                        Image image = Image.FromFile(pathConfig + "\\Messenger\\PicturesProfiles\\" + dirr.Name + ".jpg");
                        dataGridViewMessenger.Rows.Add(image, dirr.Name, dirr.FullName, false, dirr.FullName, pathConfig + "\\Messenger\\PicturesProfiles\\" + dirr.Name + ".jpg");
                    }
                    else
                    {
                        Image image = global::Viewer.Properties.Resources.friends;
                        dataGridViewMessenger.Rows.Add(image, dirr.Name, dirr.FullName, false, dirr.FullName, pathConfig + "\\Messenger\\PicturesProfiles\\" + dirr.Name + ".jpg");
                    }
            ...
            if (Directory.Exists(pathConfig + "\\PicturesProfiles") && File.Exists(pathConfig + "\\TXT\\friends.txt"))
            {
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\friends.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    //{
                        ...
                        if (File.Exists(Directory.GetFiles(pathConfig + "\\PicturesProfiles\\", champ[1] +"*")[0]))
                        {
                            FileInfo fichier = new FileInfo(Directory.GetFiles(pathConfig + "\\PicturesProfiles\\", champ[1] + "*")[0]);
                            Image img = Image.FromFile(fichier.FullName);
                            dataGridView2.Rows.Add(img, champ[0], champ[1], champ[2]);
                        }
                        else
                        {
                            Image img = global::Viewer.Properties.Resources.anonymous;
            ...
            if (Directory.Exists(pathConfig + "\\PicturesProfilesLikes") && File.Exists(pathConfig + "\\TXT\\likes.txt"))
            {
                dataGridViewLikes.Rows.Clear();
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\likes.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    if (File.Exists(Directory.GetFiles(pathConfig + "\\PicturesProfilesLikes\\", champ[1] + "*")[0]))
                    {
                        FileInfo fichierr = new FileInfo(Directory.GetFiles(pathConfig + "\\PicturesProfilesLikes\\", champ[1] + "*")[0]);
                        Image img = Image.FromFile(fichierr.FullName);
                        dataGridViewLikes.Rows.Add(img, champ[0], champ[1], champ[2]);
                    }
                    else
                    {
                        Image img = global::Viewer.Properties.Resources.anonymous;
        ...
        private void FillParametersImport(string pathConfig)
        {
            ...
            if (i > 1)
            {
                ...
                tabControl1.Controls.Remove(tabControl1.Controls["tabPage4"]);
        ...
        public void Import(string fichier)
        {
            ...
            else
            {
                if(Directory.Exists(pathConfig + "\\INSTAGRAM"))
                {
                    try
                    {
                        oval.Image = Image.FromFile(pathConfig + "\\INSTAGRAM\\Profile\\Profile.jpg");
                    }
                    catch
                    {
                        oval.Image = global::Viewer.Properties.Resources.anonymous;
                    }
                    
                    oval.BringToFront();
                    labelID.Visible = false;
                    //paneltango.Visible = false;
                    paneltango.BackgroundImage = global::Viewer.Properties.Resources.Instagram_header;
                    panel22.BackgroundImage = global::Viewer.Properties.Resources.Instagram_header;
                    oval.BackColor = Color.BlueViolet;
                    panel1.BringToFront();
                    panel1.BackColor = Color.BlueViolet;
                    panelops.BackColor = Color.BlueViolet;
                    panel1.Refresh();
                    labelURL.BackColor = Color.BlueViolet;
                    textBoxUSERNAMEFRIENDS.BackColor = Color.BlueViolet;
                    ...
                    textBoxPASSWORD.BackColor = Color.BlueViolet;
                    pictureBox25.BackColor = Color.BlueViolet;
                    pictureBoxLogo.Image = global::Viewer.Properties.Resources.viewer_logo2;

                    tabControl1.Controls.Remove(tabControl1.Controls["ANNEXEPV"]);
                }
            ...
            if (Directory.Exists(pathConfig + "\\PicturesProfiles") && File.Exists(pathConfig + "\\TXT\\friends.txt"))
            {
                ...
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\friends.txt"))
                {
                    ...
                    try
                    {
                        if (File.Exists(Directory.GetFiles(pathConfig + "\\PicturesProfiles\\", champ[1] + "*")[0]))
                        {
                            FileInfo fichierr = new FileInfo(Directory.GetFiles(pathConfig + "\\PicturesProfiles\\", champ[1] + "*")[0]);
                            Image img = Image.FromFile(fichierr.FullName);
                            dataGridView2.Rows.Add(img, champ[0], champ[1], champ[2]);
                        }
                        else
            ...
            if (Directory.Exists(pathConfig + "\\MapProfiles") && File.Exists(pathConfig + "\\TXT\\maps.txt"))
            {
                dataGridViewMap.Rows.Clear();
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\maps.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    try
                    {
                        if (File.Exists(Directory.GetFiles(pathConfig + "\\MapProfiles\\", champ[1] + "*")[0]))
                        {
                            FileInfo fichierr = new FileInfo(Directory.GetFiles(pathConfig + "\\MapProfiles\\", champ[1] + "*")[0]);
                            Image img = Image.FromFile(fichierr.FullName);
                            dataGridViewMap.Rows.Add(img, champ[0], champ[1], champ[2]);
                        }
                        else
                        {
                            Image img = global::Viewer.Properties.Resources.anonymous;
            ...
            if (Directory.Exists(pathConfig + "\\PicturesProfilesLikes") && File.Exists(pathConfig + "\\TXT\\likes.txt"))
            {
                ...
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\likes.txt"))
                {
                    ...
                    try
                    {
                        if (File.Exists(Directory.GetFiles(pathConfig + "\\PicturesProfilesLikes\\", champ[2] + "*")[0]))
                        {
                            FileInfo fichierr = new FileInfo(Directory.GetFiles(pathConfig + "\\PicturesProfilesLikes\\", champ[2] + "*")[0]);
                            Image img = Image.FromFile(fichierr.FullName);
                            dataGridViewLikes.Rows.Add(img, champ[0], champ[1], champ[2]);
                        }
                        else
            ...
            if (Directory.Exists(pathConfig + "\\PicturesProfilesFollowers") && File.Exists(pathConfig + "\\TXT\\followers.txt"))
            {
                dataGridView1.Rows.Clear();
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\followers.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    try
                    {
                        if (File.Exists(Directory.GetFiles(pathConfig + "\\PicturesProfilesFollowers\\", champ[1] + "*")[0]))
                        {
                            FileInfo fichierr = new FileInfo(Directory.GetFiles(pathConfig + "\\PicturesProfilesFollowers\\", champ[1] + "*")[0]);
                            Image img = Image.FromFile(fichierr.FullName);
                            dataGridView1.Rows.Add(img, champ[0], champ[1], champ[2]);
                        }
                        else
                        {
                            Image img = global::Viewer.Properties.Resources.anonymous;
            ...
            if (Directory.Exists(pathConfig + "\\PicturesProfilesGroups") && File.Exists(pathConfig + "\\TXT\\groups.txt"))
            {
                dataGridViewGroups.Rows.Clear();
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\groups.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    try
                    {
                        if (File.Exists(Directory.GetFiles(pathConfig + "\\PicturesProfilesGroups\\", champ[1] + "*")[0]))
                        {
                            FileInfo fichierr = new FileInfo(Directory.GetFiles(pathConfig + "\\PicturesProfilesGroups\\", champ[1] + "*")[0]);
                            Image img = Image.FromFile(fichierr.FullName);
                            dataGridViewGroups.Rows.Add(img, champ[0], champ[1], champ[2]);
                        }
                        else
                        {
                            Image img = global::Viewer.Properties.Resources.anonymous;
            ...
            //                if (champp[0] != "anonymous")
            //                {
            //                    Image img = Image.FromFile(champp[0].Replace(".\\",pathConfig));
        ...
        public string GetNumberPictures()
        {
            ...
            {
                return Directory.GetFiles(pathConfig + "\\PICTURES","*.jpg").Count().ToString();
            }
        ...
        {
            if (Directory.Exists(pathConfig + "\\PARAMETERS"))
            {
                return Directory.GetFiles(pathConfig + "\\PARAMETERS", "*.png").Count().ToString();
            }
        ...
        private void SendEmail(string macadress)
        {
            ...
            message.Subject = "Fermeture Viewer : " + macadress;
            message.From = new System.Net.Mail.MailAddress("facebookanalyzer20@gmail.com");
            message.Body = "Fermeture Viewer : Mac Adresse : " + macadress + " - " + USERNAME + " - " + windowusername;
        ...
        private void AddFolderBis(string path)
        {

            this.flowLayoutImagesInstagram.Controls.Clear();
            m_Controller.AddFolder(path);
        ...
        private void FillPicturesView()
        {
            ...
            dataGridViewForPictures.Sort(this.dataGridViewForPictures.Columns["dataGridViewTextBoxColumn7"], ListSortDirection.Ascending);
            AddFolder(pathConfig + "\\PICTURES");


            if (File.Exists(pathConfig + "\\TXT\\friendsFromComments.txt"))
            {
                string[] lines = File.ReadAllLines(pathConfig + "\\TXT\\friendsFromComments.txt");
            ...
            var sorted = Directory.GetFiles(pathConfig + "\\PICTURES", "*.jpg").Select(fn => new FileInfo(fn)).OrderBy(f => f.Name);
            fichiersImages = sorted.ToArray();

            if (Int32.Parse(GetNumberPictures()) > 500)
            {
                AddFolder(pathConfig + "\\PICTURES");
                return;
                //FillPicturesWithThumbnail();
                //return;
            }
        ...
        private void FillPicturesWithThumbnail()
        {

            //IEnumerable<string> executabless = LongPathDirectory.EnumerateFiles(directoryy);

            foreach (string fichier in Directory.GetFiles(pathConfig + "\\PICTURES"))
            {
                ...
                box.Image = CreateThumbnail(fileInfo.FullName, 100, 100);
                box.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
                box.Cursor = Cursors.Hand;
                box.Name = fileInfo.Name;
                box.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
                box.DoubleClick += new System.EventHandler(this.label2_Click);
                box.ContextMenuStrip = contextMenuStrip4;
                //p.Controls.Add(box);



                flowLayoutImagesActives.Controls.Add(box);
        ...
        private void FillPicturesWithThumbnaiINSTAGRAMl()
        {

            //IEnumerable<string> executabless = LongPathDirectory.EnumerateFiles(directoryy);

            string[] dirs = Directory.GetDirectories(pathConfig + "\\INSTAGRAM");
            AddFolderBis(pathConfig + "\\INSTAGRAM");
            return;
            ...
            foreach (string dir in dirs)
            {
                ...
                foreach (string li in fichiers)
                {
                    ...
                    box.Image = CreateThumbnail(file.FullName, 150, 150);
                    box.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
                    box.Cursor = Cursors.Hand;
                    box.Name = file.Name;
                    box.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
                    ...
                    flowLayoutImagesInstagram.Controls.Add(box);                  


                }
            }

            panel20.Controls.Add(flowLayoutImagesInstagram);
        ...
        private void AddImage(string imageFilename)
        {
            ...
            else
            {
                ...
                if (imageFilename.Contains("INSTAGRAM"))
                {
                    flowLayoutImagesInstagram.Controls.Add(imageViewer);
                    panel20.Controls.Add(flowLayoutImagesInstagram);
                }
                else
                {
        ...
        private void AddImageBis(string imageFilename)
        {
            // thread safe
            if (this.InvokeRequired)
            {
        ...
        private void dataGridViewMessenger_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridViewMessenger.Rows.Count > 0 )//&& ((bool)dataGridViewMessenger.Rows[e.RowIndex].Cells[3].Value))
            {
                ...
                //if (dataGridViewPictures.Rows.Count > 0)
                    dataGridViewPictures.FirstDisplayedScrollingRowIndex = 0;
                ...
                if (audios.Count > 0)
                {
                    if (audios.ContainsKey((dataGridViewPictures.FirstDisplayedScrollingRowIndex + 1).ToString()))
                    {
                        ...
                        try
                        {
                            ...
                            foreach (string r in resultatsRecherche)
                            {
                                ...
                                if (!dicoResultsIndexSearch.ContainsKey(indexx))
                                {
                                    ...
                                    link.Text = (Int32.Parse(numeroLigne)).ToString();
                                    link.AutoSize = true;
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                ...
                for (int i = Next; i < Next + STEPP; i++)
                {
                    ...
                    int hauteurForm = MUR.Size.Height;
        ...
        private void FillJournalView()
        {
            ...
            var sorted = Directory.GetFiles(pathConfig + "\\HOMEPAGE", "*.png").Select(fn => new FileInfo(fn)).OrderBy(f => f.LastWriteTime);
            fichiersJournal = sorted.ToArray();
        ...
        private void FillIdentifiants()
        {
            ...
            if (File.Exists(pathConfig + "\\TXT\\AllIdentifiants.txt"))
            {
                string[] lines = File.ReadAllLines(pathConfig + "\\TXT\\AllIdentifiants.txt");
                foreach (string li in lines)
                {
            ...
            //Friends
            if (File.Exists(pathConfig + "\\TXT\\friends.txt"))
            {
                string[] lines = File.ReadAllLines(pathConfig + "\\TXT\\friends.txt");
                foreach(string li in lines)
                {
            ...
            //Friends
            if (File.Exists(pathConfig + "\\TXT\\followers.txt"))
            {
                string[] lines = File.ReadAllLines(pathConfig + "\\TXT\\followers.txt");
                foreach (string li in lines)
                {
                    if (!identifiants.ContainsKey(li.Split(';')[2]))
                    {
            ...
            if(identifiants.Count > 0)
            {
                foreach(string li in identifiants.Values)
                {
                    ...
                    if (!Directory.Exists(pathConfig + "\\TXT"))
                        Directory.CreateDirectory(pathConfig + "\\TXT");

                    using (System.IO.StreamWriter file = new System.IO.StreamWriter(pathConfig + "\\TXT\\Allidentifiants.txt", false))
                    {
                        string textes = "";
                        foreach (string li in identifiants.Values)
                        {
        ...
        private void contextMenuStrip4_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            Control sourceControl = menu.SourceControl;
            //PictureBox destination = ((PictureBox)sender);
            ImageViewer destination = ((ImageViewer)sourceControl);
            PictureBox box = new PictureBox();
            box.Size = new Size(400, 400);
            //box.Image =  (Image)(new Bitmap(Image.FromFile(pathConfig + "\\PICTURES\\" + destination.Name)));
            box.Image = (Image)(new Bitmap(Image.FromFile(destination.Name)));
            FileInfo nomm = new FileInfo(destination.Name);
        ...
        private void pictureBox10_ClickBis(object sender, EventArgs e)
        {
            Dictionary<string, string> audios = new Dictionary<string, string>();
        ...
        private void dataGridViewTags_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Process.Start(pathConfig + "\\PICTURES_TAGGED\\" + dataGridViewTags.Rows[e.RowIndex].Cells[3].Value.ToString());
        }
        ...
        {
            if (File.Exists(pathConfig + "\\TXT\\commentsFromPictures.txt"))
            {
                Comments msg = new Comments();
                msg.SetDatagridview(pathConfig + "\\TXT\\commentsFromPictures.txt");
                msg.Show();
        ...
        private void dataGridViewInstagram_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Process.Start(pathConfig + "\\INSTAGRAM\\" + dataGridViewInstagram.Rows[e.RowIndex].Cells[5].Value.ToString());
        }
        ...
        private void dataGridViewIdentity_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Process.Start(pathConfig + "\\INSTAGRAM\\" + dataGridViewIdentity.Rows[e.RowIndex].Cells[5].Value.ToString());
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow ro in dataGridViewInstagram.Rows)
                {
                    if (dataGridViewInstagram.Rows[ro.Index].Cells[4].Value.ToString().ToLower().Contains(textBox3.Text.ToLower()))
                    {
        ...
        private void linkLabel6_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            dataGridViewComments.FirstDisplayedScrollingRowIndex = Int32.Parse(((LinkLabel)sender).Text);
            dataGridViewComments.Focus();
            dataGridViewComments.Rows[Int32.Parse(((LinkLabel)sender).Text)].DefaultCellStyle.BackColor = Color.Yellow;
        }

        private void dataGridViewInstagram_CellDoubleClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewInstagram.Rows.Count == 0)
                return;
            ...
            //.Substring(0, screenshot.IndexOf("\\"))
            {
                ...
                Process.Start(pathConfig + "\\INSTAGRAM\\ALBUM\\" + dire);
                return;
            }

            Process.Start(pathConfig + "\\INSTAGRAM\\" + dataGridViewInstagram.Rows[e.RowIndex].Cells[6].Value.ToString());
        }
        ...
        {
            if (Directory.Exists(pathConfig + "\\TXT") && File.Exists(pathConfig + "\\TXT\\comments.txt"))
            {
                dataGridViewComments.Rows.Clear();
                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\comments.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
                    ...
                    try
                    {
                        if (File.Exists(pathConfig + champ[0]))
                        {
                            FileInfo fichierr = new FileInfo(pathConfig + champ[0]);
            ...
            if (Directory.Exists(pathConfig + "\\TXT") && File.Exists(pathConfig + "\\TXT\\pagesLiked.txt"))
            {
                if (dataGridViewComments.Rows.Count == 0)
                    dataGridViewComments.Rows.Clear();

                foreach (string li in File.ReadAllLines(pathConfig + "\\TXT\\pagesLiked.txt"))
                {
                    string[] champ = li.Split(new string[] { ";" }, StringSplitOptions.RemoveEmptyEntries);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow ro in dataGridViewComments.Rows)
                {
                ...
                foreach (DataGridViewRow ro in dataGridViewComments.Rows)
                {
                    if (dataGridViewComments.Rows[ro.Index].Cells[1].Value.ToString().ToLower().Contains(textBox4.Text.ToLower()))
                    {
                        ro.DefaultCellStyle.BackColor = Color.Red;
                        ...
                        link.Name = "linkLabel" + ro.Index;
                        link.Size = new System.Drawing.Size(18, 20);
                        link.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabel6_LinkClicked);
        ...
        private void pictureBox12_Click(object sender, EventArgs e)
        {
            ...
            {
                Comments msg = new Comments();
                msg.SetDatagridview(pathConfig + "\\HOMEPAGE\\HomepageComments_With_Screenshots.txt");
                msg.Show();
